...
{{#ide-configuration}} ### IDE Configuration for {{provider.name}}
...
{{#case "claude-code"}}
{{#cli-configuration}} ### CLI Configuration for {{provider.name}}
...
_Provider: {{provider.name}} ({{provider.id}})_  
_Configuration: {{file.path}}_
