...
1. **Plans (`@plans.md`)**:
   ...
   - **Details**: For plan creation, fully review the [.task-magic/plans.md](plans.md) rule file.
2. **Tasks (`@tasks.md`)**:
   ...
   - **Details**: For task creation, fully review the [.task-magic/tasks.md](tasks.md) rule file.
3. **Memory (`@memory.md`)**:
   ...
   - **Details**: For storing to memory, fully review the [.task-magic/memory.md](memory.md) rule file.
